...
class SubtitleItem {
    ...
    public boolean equals(Object o) {
        ...
        SubtitleItem subtitleItem = (SubtitleItem) o;
        return Objects.equals(begin, subtitleItem.begin)
                && Objects.equals(end, subtitleItem.end)
                && Objects.equals(values, subtitleItem.values);
    }

    @Override
    public int hashCode() {
        int result = values == null ? 0 : values.hashCode();
...
class LocalTimeTypeAdapter extends TypeAdapter<LocalTime> {
    private final DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern("HH:mm:ss.AAAA");
